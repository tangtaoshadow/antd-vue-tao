 ...
 * @Last Modified time: 2019-11-22 20:11:51
 */
export default {
  name: "home",
  data() {
...
<template>
  <div>
    <a-row type="flex" justify="space-around" style="padding:20px 0px;">
      <a-col :sm="24">
    ...
    <a-row type="flex" justify="space-around" style="padding:20px 50px 40px;">
      ...
      <a-col :sm="23" :md="7" :lg="6" :xl="5" :style="footer_col_style" style="max-width:370px;">
      ...
      <a-col :md="7" :lg="6" :xl="5" :style="footer_col_style" style="max-width:370px;">
        <div style="font-size:16px;font-weight:700;text-align:left;" v-pointer>
          &nbsp;Official Documents
          <div style="height:10px;width:100%;border-top:1px solid #000;"></div>
          <span style="font-size:14px;font-weight:500;">
